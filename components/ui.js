...
function IconTab({ name, on }) {
  ...
  if (name === "studio")
    return (<svg width="23" height="23" viewBox="0 0 24 24"><path {...p} d="M14.5 6.5 4.8 16.2a1.6 1.6 0 0 0 0 2.3l.7.7a1.6 1.6 0 0 0 2.3 0l9.7-9.7" /><path {...p} d="M14.5 6.5l3-3 3 3-3 3" /><path {...p} d="M5.5 5V8M4 6.5h3M19 13.5v2.5M17.8 14.7h2.5" /></svg>);
