...
export async function pullFromCloud(userId) {
  ...
  try {
    ...
    // "visto" nunca volta atrás: se já foi visto neste aparelho, mantém —
    // evita loop quando o push ainda não chegou na nuvem.
    s.celebracaoVista = s.celebracaoVista || !!prof.celebracao_vista;
